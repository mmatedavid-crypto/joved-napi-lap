  ...
  component: () => (
    <Layout>
      ...
      <div className="mx-auto max-w-2xl px-4 md:px-6 pb-20 space-y-4">
        <Section eyebrow="Mit kínálunk">
          Napi lapot, három lapos tarot húzást, döntés előtti és randi előtti olvasatot, sorsszámot
          és párkapcsolati összeillést. Magyarul, mértékkel.
        </Section>
        <Section eyebrow="Hogyan írunk">
          Rövid, intim, kicsit irodalmi nyelven. Nem ígérünk biztosat, mert nem tudunk. Inkább
          irányt mutatunk.
        </Section>
