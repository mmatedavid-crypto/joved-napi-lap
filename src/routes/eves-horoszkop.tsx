...
export const Route = createFileRoute("/eves-horoszkop")({
  head: () => ({
    meta: [
      { title: "Személyes éves horoszkóp — 12 hónap a saját képletedre | Jövőd.hu" },
      {
        name: "description",
        content:
          "Személyes éves horoszkóp születési képletedből: havi bontás 12 hónapra, kiemelt időablakok, szerelem és munka. 4990 Ft.",
      },
      { name: "robots", content: "index,follow" },
    ],
    links: [{ rel: "canonical", href: `${SITE_LEGAL.siteUrl}/eves-horoszkop` }],
  }),
  component: Page,
});
        ...
        <form onSubmit={onSubmit} className="surface p-6 space-y-5">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Pl. Mire figyeljek idén a kapcsolatomban?"
              rows={3}
              className="w-full bg-transparent border border-[oklch(0.78_0.10_80/0.25)] rounded-md px-4 py-3 text-ivory placeholder:text-ivory/40 focus:border-gold outline-none"
            />
          </div>
