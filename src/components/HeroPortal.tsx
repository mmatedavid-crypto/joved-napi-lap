  ...
  return (
    <div className={`relative aspect-square ${className}`}>
      ...
      <svg viewBox="0 0 400 400" className="relative w-full h-full animate-float">
        ...
        />
        <path
          d="M160 280 Q160 170 200 130 Q240 170 240 280 Z"
          stroke="url(#hg)"
          strokeWidth="1"
          fill="oklch(0.10 0.04 295)"
        />
        <path
          d="M200 160 L205 178 L223 180 L208 190 L213 208 L200 197 L187 208 L192 190 L177 180 L195 178 Z"
          fill="url(#hg)"
        />
        <path
          d="M205 230 a14 14 0 1 1 -10 -13 a10 10 0 1 0 10 13 z"
          fill="url(#hg)"
          opacity="0.9"
        />
        <path
          d="M175 280 L225 280 M180 285 L220 285 M185 290 L215 290 M188 295 L212 295"
          stroke="url(#hg)"
          strokeWidth="0.8"
        />
        {[
