...
/* ──────────────────────────────────────────────────────────────────────
   Antique tarot card system — uses hand-rendered illustrations as faces.
   Overlays a title banner (top) and keyword banner (bottom) in the
   project's gold + ivory palette so every card stays consistent even
   though the source illustrations vary.
   ────────────────────────────────────────────────────────────────────── */
  ...
  return (
    <div className={`tarot-card ${className}`} style={{ animation: "reveal-flip .8s ease-out" }}>
      ...
      <div className="absolute left-[6%] right-[6%] top-[4%] pointer-events-none">
        <div className="relative rounded-[6px] border border-[oklch(0.78_0.10_80/0.55)] bg-[linear-gradient(180deg,oklch(0.12_0.05_295/0.92),oklch(0.08_0.04_295/0.88))] shadow-[inset_0_0_0_1px_oklch(0.78_0.10_80/0.18)] px-2 py-1 text-center">
          {label && (
