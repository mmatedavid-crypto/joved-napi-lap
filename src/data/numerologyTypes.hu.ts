...
export const EVES_SZAM: NumerologyType = {
  ...
  lead: "A személyes éved a numerológiai hagyomány szerint azt mutatja, milyen témák kerülhetnek könnyebben előtérbe a 9 éves ciklusban.",
  intro:
    "A személyes év egy 9 éves spirálban mozog. Minden évhez jellegzetes téma kapcsolódik: új kezdetek, együttműködés, alkotás, építkezés, változás, felelősség, befelé fordulás, beérés, lezárás. Ha tudod, melyik évedben vagy, könnyebb lehet józanul ránézni arra, milyen visszatérő minták kérnek most több figyelmet.",
  howTo:
  ...
  numbers: [
    { n: 1, title: "1-es személyes év — Új kezdet", body: "Magvetés éve. Új projektek, új irány, új önállóság kerülhet előtérbe. Amit most elindítasz, később fontos viszonyítási ponttá válhat, ezért érdemes józanul és tiszta szándékkal kezdeni." },
    { n: 2, title: "2-es személyes év — Türelem és kapcsolat", body: "Lassú érlelődés, partnerségek építése. Ne erőltess gyors eredményt — most a kapcsolatok, az együttműködések és a türelmes egyeztetés adhatnak jobb irányt." },
    ...
    { n: 7, title: "7-es személyes év — Befelé fordulás", body: "Csend, tanulás, befelé figyelés. A külső eredmények hajszolása helyett most értékesebb lehet a megértés, a pihenés, az olvasás vagy a kutatás — ne erőltess döntéseket." },
