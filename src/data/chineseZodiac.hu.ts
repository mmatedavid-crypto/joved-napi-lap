...
export const CHINESE_ANIMALS: ChineseAnimal[] = [
  ...
  },
  {
    ...
    health: "A folyamatos pörgés hamar szétszórhatja. Szüksége van lekapcsoló hobbira, csendes estére és olyan alvásritmusra, amely nem csak utólag javítja a napot.",
  ...
  },
  {
    ...
    career: "Rendszerező, elemző, adminisztratív, minőségbiztosítási vagy design jellegű munka — mindenhol, ahol a pontosság és a keretek számítanak.",
    money: "Megfontoltan keres és költ. Szereti a látható minőséget, de nem szórja el a vagyonát.",
    health: "A perfekcionizmus nála belső feszültséggé válhat. Engednie kell, hogy a tökéletlen is jó legyen, különben a napjai túl szorosra záródnak.",
  ...
  },
  {
    ...
    health: "Az élvezetek szeretete akkor támogatja, ha mértékkel párosul. Jót tesz neki a lassabb tempó, az egyszerű ritmus és a tudatos határ az öröm és a túlzás között.",
