...
export const CARDS: TarotCard[] = [
  ...
  { id: "szerelmesek", name: "A Szerelmesek", keywords: ["választás", "értékrend", "kapcsolódás"],
  ...
  { id: "igazsag", name: "Az Igazságosság", keywords: ["egyensúly", "felelősség", "tisztánlátás"],
  ...
  { id: "akasztott", name: "Az Akasztott Ember", keywords: ["nézőpont", "felfüggesztés", "engedés"],
