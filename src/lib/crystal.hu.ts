...
export const CRYSTAL_HU: Record<string, CrystalMeaning> = {
  ...
  Karneol: {
    ...
    quality: "A halogatásból kimozdító lendületet jelképezi.",
    when: "Amikor sokat tervezel, de keveset lépsz.",
    oneLine: "Most lépj egyet.",
  },
  Obszidián: {
    symbol: "A belső igazság és határhúzás köve.",
    quality: "A kerülgetett igazsággal való szembenézést jelképezi.",
  ...
  "Fekete turmalin": {
    ...
    quality: "Annak letételét jelképezi, ami nem a tiéd.",
  ...
  Akvamarin: {
    ...
    quality: "A higgadt, kerek mondatokban való megszólalást jelképezi.",
  ...
  Gránát: {
    ...
    quality: "Az újraéledő életkedv és belső tűz jelképe.",
  ...
  Türkiz: {
    ...
    quality: "Az őszinte megszólalás bátorságát jelképezi.",
