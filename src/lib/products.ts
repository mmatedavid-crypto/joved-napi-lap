...
export const PRODUCTS: ProductDef[] = [
  ...
  },
  {
    ...
    qualityPromise: "Azonnali napi iránytű személyes, józan rituáléhanggal.",
    priceHuf: 690,
    category: "instant",
  ...
  },
  {
    ...
    qualityPromise: "Szimbolikus számértelmezés, józanul megfogalmazva, önismereti fókuszban.",
    priceHuf: 590,
    category: "instant",
  ...
  },
  {
    ...
    qualityPromise: "Szimbolikus kristályajánlás a mostani témádhoz, józan önismereti keretben.",
    priceHuf: 590,
    category: "instant",
  ...
  },
  {
    ...
    qualityPromise: "Önismereti álomfejtés belső tükörként, nyugodt és óvatos hangon.",
    priceHuf: 790,
    category: "instant",
  ...
  },
  {
    ...
    qualityPromise: "Rövid, személyes napi horoszkóp józan, hagyományalapú hangon.",
    priceHuf: 790,
    category: "instant",
  ...
  },
  {
    ...
    qualityPromise: "Az extra húzás új tarot-nézőpontot ad ugyanahhoz a belső kérdéshez.",
    priceHuf: 590,
    category: "instant",
    sourceRoute: "/mai-lap",
  },
  {
    ...
    qualityPromise:
      "Részletesebb, összefüggő olvasat, ahol a három lap közös történetté áll össze.",
    priceHuf: 990,
    category: "instant",
  ...
  },
  {
    ...
    qualityPromise: "10 lapos, több pozíciós tarot-olvasat: részletesebb, összefüggő elemzés.",
    priceHuf: 990,
    category: "instant",
    sourceRoute: "/harom-lap",
  },
  ...
  },
  {
    ...
    qualityPromise: "Komplex, grafikus, többoldalas védikus képlet-olvasat.",
    priceHuf: 1990,
    category: "delayed",
    standardHours: 24,
