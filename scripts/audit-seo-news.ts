...
const checks: Check[] = [
  ...
  },
  {
    ...
    includes: [
      ...
      "ReadingLoadingState",
      'kind="horoscope"',
      "rövid, átnézett és használható olvasat",
      "Készül a friss horoszkópod",
      "holdfázisát és kiemelt témáit",
      "a horoszkóp hagyománya",
      "józanul olvassuk össze",
      "loadingSteps",
      ...
      "Tiszta, átnézett olvasat",
    ],
    excludes: [
      "természetes magyar olvasattá",
      "közérthető magyar nyelven fogalmazzuk meg",
      "Nem rövid sablonüzenetet adunk",
      "Nálunk nem egy rövid, általános sablonszöveg",
      "háttéradat",
    ],
  },
  {
