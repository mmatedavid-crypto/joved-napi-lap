...
const checks: Check[] = [
  ...
  },
  {
    ...
    includes: [
      ...
      "ReadingLoadingState",
      'kind="horoscope"',
      "nem egy előre megírt horoszkóp-szöveg",
      "Készül a friss horoszkópod",
      "jegyforrást, holdfázist és kiemelt témákat vesszük alapul",
      "természetes, hű magyar olvasatot",
      "loadingSteps",
      "forrását kérjük le",
      "Ha a forrás holdfázist, színt vagy számot ad",
      "hűen magyarítjuk",
      "korábbi jó minőségű mentést keresünk",
