...
const checks: Check[] = [
  ...
  },
  {
    ...
    excludes: ["delivery_email_error", "delivery_email_queued_at", "legbiztosabb közvetlen hozzáférés"],
  ...
  },
  {
    ...
    excludes: ["Sajnos hiba történt", "Kapcsolódási hiba", "állapotlekérés", "az olvasatot, vagy visszatérítjük"],
    enforceExcludes: true,
  },
  {
  ...
  },
  {
    ...
    excludes: ["delivery_email_error", "delivery_email_queued_at", "profilnézet marad a biztos hozzáférésed"],
    enforceExcludes: true,
  },
  {
  ...
  },
  {
    ...
    includes: [
      ...
      "rövid pontosítási vázlattal",
      "mi maradt ki vagy hol csúszott félre",
      "olvasat teljes szövegét nem tesszük bele automatikusan",
      "Nem kell a teljes olvasatot bemásolni",
      "elég azt a részt vagy érzést megírni",
      "SITE_LEGAL.supportEmail",
    ],
    excludes: ["Most nem sikerült menteni a visszajelzést, de emailben elküldheted."],
  },
  {
