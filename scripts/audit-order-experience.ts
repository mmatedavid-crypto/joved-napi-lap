...
const checks: Check[] = [
  ...
  },
  {
    ...
    includes: [
      ...
      "a vásárlási email és a rendelésazonosító alapján utánanézünk",
    ...
    excludes: [
      ...
      "a rendelés nem vész el; utánanézünk, és a gyorsítás díját külön rendezzük",
    ],
    enforceExcludes: true,
  },
  {
  ...
  },
  {
    ...
    includes: [
      ...
      "figyelmet kér",
      "Az érintett",
      "rendelés nem vész el: újrapróbálhatod a feldolgozást",
      "vásárlási",
  ...
  },
  {
    ...
    includes: [
      ...
      "Ha pontosítást kérsz, a vásárlási email címedről írj, és erre az azonosítóra hivatkozz.",
      ...
      "SITE_LEGAL.supportEmail",
      "a gyors visszakereséshez a vásárlási email címedről írj",
      "add meg a rendelésazonosítót",
      ...
      "A vásárlási email címed és a rendelésazonosító alapján gyorsabban visszanézzük",
      "Innen folytathatod",
