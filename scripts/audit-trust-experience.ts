...
const checks: Check[] = [
  ...
  },
  {
    ...
    includes: [
      ...
      "Ha konkrét választ vagy javítást kérsz, a vásárlási email címedről írj",
    ...
    excludes: [
      "az olvasat eltalált",
      "részben talált",
      "a felhasználó a kapcsolati email címen kérhet segítséget",
      "rendelési azonosítóval együtt írj a kapcsolati email címre",
    ],
  },
  {
  ...
  },
  {
    ...
    includes: [
      ...
      "A korábbi rendeléseid nem vesznek el",
      "korábbi rendeléseid nem vesznek el; próbáld újra, vagy írj nekünk a vásárlási email címedről",
      "A vendégvásárlásaid nem vesznek el; próbáld újra pár perc múlva, vagy írj nekünk a vásárlási email címedről",
      "A korábbi rendeléseid nem vesznek el; próbáld újra pár perc múlva, vagy írj nekünk a vásárlási email címedről",
    ...
    excludes: [
      ...
      "korábbi rendeléseid nem vesznek el; próbáld újra, vagy írj nekünk.",
      "A vendégvásárlásaid nem vesznek el; próbáld újra pár perc múlva, vagy írj nekünk.",
      "A korábbi rendeléseid nem vesznek el; próbáld újra pár perc múlva, vagy írj nekünk.",
      "text-red-300",
    ],
  },
  {
  ...
  },
  {
    ...
    includes: [
      ...
      "Frissíts rá pár perc múlva, vagy írj nekünk erről az email címről",
      "SITE_LEGAL.supportEmail",
  ...
  },
  {
    ...
    includes: [
      ...
      'setStatus(r.status >= 500 ? "error" : "invalid")',
      "Jövőd.hu leiratkozási segítség",
      "mailto:${SITE_LEGAL.supportEmail}",
    ],
    excludes: [
      "Valami megakadt. Kérlek próbáld újra később.",
  ...
  },
  {
    ...
    includes: [
      ...
      "Újrapróbálom",
      "Vissza a főoldalra",
      "Ha fizetés vagy elkészült olvasat közben akadtál el",
      "ne indíts új fizetést",
      "vásárlási email címedről",
      "és utánanézünk",
      "SITE_LEGAL.supportEmail",
    ...
    excludes: [
      ...
      "próbáld frissíteni az oldalt, vagy térj vissza a főoldalra.</p>",
      "írj a vásárlási email címedről:",
      "Try again",
      "Go home",
    ],
  },
